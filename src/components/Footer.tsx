        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gradient-to-r from-gray-700 to-gray-600 rounded-lg flex items-center justify-center text-gray-400 hover:from-purple-500 hover:to-purple-600 hover:text-white transition-all duration-300 group hover:scale-110"
                aria-label="Twitter"
              >
                <svg
                  className="h-5 w-5 group-hover:animate-pulse"
